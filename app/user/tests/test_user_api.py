...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        """Test creating an user is scussessfull."""
        payload = {
    ...
    def test_password_too_short_error(self):
        """Test an error returend if the password less than 5 chars."""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test User',
    ...
    def test_create_token_for_user(self):
        """Test token gerenrated for valid credentails"""
        user_details = {
            'name': 'Test name',
            'email': 'test@example.com',
            'password': 'testpass123',
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_profile_success(self):
        """Test retrieving profile for logged in ussers."""
        res = self.client.get(ME_URL)
    ...
    def test_post_me_not_allowed(self):
        """Test POST is not allowed for ME nd point."""
